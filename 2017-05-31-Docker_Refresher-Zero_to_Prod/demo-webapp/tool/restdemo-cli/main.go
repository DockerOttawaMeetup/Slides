...
import (
	...
	"github.com/hairyhenderson/restdemo/tool/cli"
...
func main() {
	...
	app := &cobra.Command{
		Use:   "WorstSocialNetwork-cli",
		Short: `CLI client for the WorstSocialNetwork service`,
	}
	...
	c.UserAgent = "WorstSocialNetwork-cli/0"
